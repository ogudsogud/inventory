...
public class TrxPartInModel {
    ...
    public TrxPartInModel(String ticket_no, String id_unit_parts, String id_unit_institution, String id_part_number, String part_name, String institution_name, String ins_unit_name, String unit_parts_name, String description, int quantity_unit, String bad_part, String returned_by, String returned_on, String approved_by, String approved_on, int status) {
