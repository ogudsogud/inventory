...
public class StockUnitModel {
    ...
    public StockUnitModel(int id_unit_parts, String unit_parts_name, int quantity_unit, String created_by, String created_on, String updated_by, String updated_on, int status) {
        this.id_unit_parts = id_unit_parts;
        this.unit_parts_name = unit_parts_name;
        this.quantity_unit = quantity_unit;
        this.created_by = created_by;
